...
const currentInstitute = computed(() =>
  store.getById(Number(props.instId))
)
...
const other      = computed(() => directions.value.filter((d) =>
  d.education_level !== 0 && d.education_level !== 1 && d.education_level !== 2
))
