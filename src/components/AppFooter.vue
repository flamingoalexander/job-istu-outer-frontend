...
<template>
  <q-footer elevated class="bg-blue-8 text-white footer-animated">
    <div class="row">
      <div class="col-3">
        <q-toolbar>
          <q-img src="/icons/favicon-96x96.png" class="logo"></q-img>
        </q-toolbar>
        <q-toolbar class="institute_div">
          <div class="q-ml-md">
            <a href="https://www.istu.edu/" style="color: white !important">
      ...
      <div class="col-3">
        <div class="q-ml-md">
          <router-link :to="{ name: 'companies' }" class="title"> Компании </router-link>
        </div>
        <div class="q-ml-md">
          <router-link :to="{ name: 'internships' }" class="title"> Практики </router-link>
        </div>
      </div>

      <div class="col-3">
        <div class="q-ml-md title">Центр карьеры:</div>
        ...
        <div class="q-ml-md title">Техническая поддержка:</div>
        <div class="q-ml-md additional_text">
      ...
      <div class="col-3">
        <div class="q-ml-md title">Организация:</div>
        <div class="q-ml-md additional_text">
