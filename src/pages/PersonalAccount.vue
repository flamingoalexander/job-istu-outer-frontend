...
const { company, username, first_name, last_name, email, status } = storeToRefs(userStore);
  ...
  <q-page class="q-pa-md bg-grey-2">
    <div class="row justify-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <!-- добавили relative-position, чтобы QInnerLoading корректно выровнялся -->
        <q-card flat bordered class="q-pa-lg q-rounded-xl relative-position">
          <!-- Оверлей загрузки, пока статус Pending -->
          <q-inner-loading :showing="status === StorageStatus.Pending">
            <q-spinner-gears size="50px" color="primary" />
          </q-inner-loading>

          <!-- Основной контент показываем только когда Ready -->
    ...
    <!-- Формы можно оставить как есть; они откроются уже при Ready -->
    <UserInfoForm
