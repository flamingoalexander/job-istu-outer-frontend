<template>
  <q-page padding>
    <div class="row q-col-gutter-md">
      ...
      <!--      >-->
      <!--        <institute-card :image-url="inst.image_url" :name="inst.name" />-->
      <!--      </router-link>-->
      <q-btn
        color="primary"
        unelevated
      ...
      <q-btn
        ...
        no-caps
        class="q-ma-md"
        :to="{ name: 'company-practices' }"
        label="Заявки на практику от лица компании (Company-Screen-2)"
      />
    </div>
  </q-page>
</template>
...
// import InstituteCard from 'components/main-page/InstituteCard.vue';
